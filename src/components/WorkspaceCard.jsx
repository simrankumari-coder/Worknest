...
const WorkspaceCard = ({ image, name, availability, location, type, price, id }) => {
    return (
        <div className='rounded-md bg-[var(--background)] shadow-xl transition-all duration-300  hover:shadow-2xl hover:shadow-teal-700/40 hover:-translate-y-2 mx-6 my-4 flex flex-col gap-2 '>
            ...
            <div className='flex flex-col gap-2 p-3'>
                <h1 className='text-teal-700 text-2xl font-bold'>{name}</h1>
